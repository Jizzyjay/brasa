...
export function PromoBanner() {
  return (
    <section className="px-4 py-8 md:px-8 md:py-12" aria-labelledby="promo-heading">
      <Reveal>
        <div className="mx-auto grid max-w-[1240px] overflow-hidden rounded-[2rem] bg-olive text-white md:grid-cols-[1.1fr_0.9fr]">
          <div className="flex flex-col justify-center px-8 py-12 md:px-12 md:py-16">
            ...
            <h2
              id="promo-heading"
              className="mt-3 font-display text-3xl leading-tight font-semibold tracking-tight md:text-5xl"
            >
