...
export function CTA() {
  return (
    <section className="px-4 py-16 md:px-8 md:py-24" aria-labelledby="cta-heading">
      <Reveal>
        <div className="relative mx-auto max-w-[1240px] overflow-hidden rounded-[1.5rem] bg-chili px-5 py-12 text-center text-white sm:rounded-[2rem] sm:px-8 sm:py-16 md:px-16 md:py-24">
          ...
          <h2
            id="cta-heading"
            className="relative font-display text-2xl font-semibold tracking-tight sm:text-3xl md:text-5xl"
          >
